...
import static com.book.interviewsexposed.FizzBuzz.alternativeFizzBuzz;
...
//        String actual = printFizzBuzz(n);
        String actual = alternativeFizzBuzz(n);
...
//        String actual = printFizzBuzz(n);
    ...
    @Test
    @DisplayName("n = 7로 주어진 경우 테스트")
        // 첫번째 edge case 3과 5 + 두번째 3의 배수인 6을 테스트
    void testCase3() {
        // given
        int n = 7;
