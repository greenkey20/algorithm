...
// ~ 20h v2 기존 코드를 어떻게 고치면 반례도 cover할 수 있을까 생각하다가, 갑자기 떠오른 생각으로 작성해봄(원래는 v3 idea를 구현하려고 했었음)
public class PaintWall {
    public static int solution(int n, int m, int[] section) {
        ...
        for (int i = section[0] + 1; i <= section[section.length - 1]; ) {
            answer++;
