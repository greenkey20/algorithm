...
/* 2023.5.5(금) 21h35 references 로직 많이 참고하며 다시 검토 -> 21h55 맞았습니다
나의 생각 = 재귀함수 매개변수로 넘기는 exponent 변수를 static으로 두면 안 되었었던 것 같다..?
...
//        System.out.println(result % c);
    ...
    public static long baseRaisedToPowerOfExponent(int exponent) {
        ...
        long divide = baseRaisedToPowerOfExponent(exponent / 2); // % divisor 없어도 '맞았습니다'
